...
$tipo_dispositivo = $datos_dispositivo->getAll();
?>
        ...
        <div class="row">
            <div class="col">
                <div class="card card-body">
                    <h3>Crear Tipo de Dispositivo:</h3>
                    <div class="mb-3">
                        <form action="../../controllers/tipoDispositivoController.php?c=1" method="POST">
                            <div class="input-group ">
                                <div class="input-group mb-3">
                                    <input type="text" name="nombre" id="nombre" class="form-control" placeholder="Ingrese un nuevo tipo dispositivo" required>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            if ($tipo_dispositivo) {
                                $pos = 1;
                                foreach ($tipo_dispositivo as $tipo_dispositivo) {
                            ?>
                        <tr>
                            <td><?= $pos ?></td>
                            <td>
                                <span id="tipo_dispositivo<?= $tipo_dispositivo->getId() ?>"> <?= $tipo_dispositivo->getTipoDispositivo() ?> </span>

                            </td>
                            <td>
                            <td>
                                <a class="btn btn-sm btn-outline-warning" onclick="show(<?= $tipo_dispositivo-> getId()  ?>)">
                                    <i class="bi bi-pencil-square" style="font-size: 1.4rem;"></i>
                                </a>
                                <a class="btn btn-sm btn-outline-danger" href="../../controllers/tipoDispositivoController.php?c=4&id_tipo_dispositivo=<?= $tipo_dispositivo-> getId() ?>">
...
<script>
    ...
    function show(id_tipo_dispositivo) {
        ...
        let elemento = document.getElementById(`tipo_tipo$tipo_dispositivo${id_tipo_dispositivo}`);
    ...
    function editar() {
        ...
        axios.post(`../../controllers/tipoDispositivoController.php?c=3&id_tipo_dispositivo=${id_tipo_dispositivo}&nombre=${nombre}`)
