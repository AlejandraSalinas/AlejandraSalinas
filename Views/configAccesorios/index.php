                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?= $pos ?></td>
                            <td>
                                <span id="id_tipo_accesorio<?= $accesorios->getId() ?>"> <?= $accesorios->getTipoAccesorio() ?> </span>
                            </td>
                            <td>
                            <td>
                                ...
                                <a class="btn btn-sm btn-outline-danger" href="../../controllers/tipoAccesorioController.php?c=4&id_tipo_accesorio=<?= $accesorios-> getId() ?>">
...
<script>
    ...
    function show(id_tipo_accesorio) {
        ...
        let elemento = document.getElementById(`tipo_accesorios${id_tipo_accesorio}`);
        let documento = elemento.textContent

        document.getElementById('nombre').value = documento
        document.getElementById('nombre').setAttribute('data-id', id_tipo_accesorio);
    }

    function editar() {

        let elemento = document.getElementById("nombre");
        let id_tipo_accesorio = elemento.dataset.id
        let nombre = elemento.value

        axios.post(`../../controllers/tipoAccesorioController.php?c=3&id_tipo_accesorio=${id_tipo_accesorio}&nombre=${nombre}`)
