...
$supervisor = $data->getPersonasByRol(5);
...
<div class="container-fluid">
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-4 text-gray-800">Crear Contrato del supervisor</h1>
    <hr class="hr mb-5">
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="mb-4 col-8">
                    <label for="id_persona" class="form-label text-center">Selecione un Supervisor:</label>
