                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-outline-danger" href="../../controllers/marcaDispositivoController.php?c=4&id_marca=<?= $marca-> getId() ?>">
...
<script>
    ...
    function show(id_marca) {
        ...
        let elemento = document.getElementById(`marcas${id_marca}`);
