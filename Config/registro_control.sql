...
CREATE TABLE IF NOT EXISTS `dispositivos` (
  ...
  KEY `id_accesorios` (`id_accesorios`),
...
INSERT INTO `dispositivos` (`id_dispositivo`, `id_persona`, `id_tipo_dispositivo`, `id_marca`, `id_color`, `id_accesorios`, `serie`, `descripcion`) VALUES
	(1, 1, 2, 1, 3, 0, 'CR57', 'PORTATIL ROJO CON NEGRO 32GB DE RAM 2.5TB M.2'),
	(2, 1, 1, 8, 3, 5, 'SFDSA', NULL),
	(3, 1, 1, 6, 3, 4, 'dadsadsadsa', NULL);
...
-- Volcando datos para la tabla registro_control.tipo_dispositivos: ~4 rows (aproximadamente)
