...
class DispositivoModel
{
    ...
    public function getById($id_dispositivo)
    {
        ...
        try {
            ...
            $sql = ' SELECT id_dispositivo, ti.nombre AS id_tipo_identificacion, p.numero_identificacion,  primer_nombre, segundo_nombre, primer_apellido, segundo_apellido, td.nombre AS id_tipo_dispositivo, m.nombre AS id_marca, c.nombre AS id_color, d.serie, descripcion 
